...
- Demand Structure in Two-Sided Markets: A Network Based Revenue Analysis Approach.
    ...
    - **Job Market Paper**
        - <small> **Abstract** The seller base is critical to a platform’s success, which can attract and retain buyers, driving platform revenue. One key decision for the platform is to manage this seller base—determine which sellers to host, prioritize, or incentivize, and how to enhance their product offerings. Accurately evaluating the economic value that sellers bring to the platform is essential. However, this evaluation is complicated by various interdependencies among buyers and sellers, such as competition or complementation among sellers, interactions between buyers and sellers, and competition among buyers. To address these challenges, this paper proposes a network-based approach that integrates multiple machine learning methods, including Variational Autoencoders (VAE), Graph Neural Networks (GNN), and Gated Recurrent Units (GRU), to capture the sellers’ revenue contributions to the platform in the context of online food delivery. Compared to the unit-based evaluation approach that is solely based on individual seller characteristics, this approach takes into account how other sellers and buyers affect the focal seller’s revenue, as well as how the focal seller impacts others. It also accounts for the evolution of the interdependencies among buyers and sellers, along with changes in their characteristics over time. Estimation results show that this model outperforms the non-network-based models, highlighting the importance of considering the network structure of the platform. Counterfactual experiments based on the estimated model further provide insights into the platform’s strategies for inviting new sellers, and assisting sellers in localizations and extending their product offerings.
